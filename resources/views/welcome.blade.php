    ...
    <section id="hero" class="relative flex items-center pt-24 pb-16 md:pt-28 md:pb-20 min-h-[88svh]">
        ...
        <div class="relative max-w-content mx-auto px-6 w-full">
                ...
                <div class="grid md:grid-cols-12 gap-8 md:gap-10 items-start">
                    ...
                    <div class="md:col-span-8 lg:col-span-9 md:order-1">
                        <div class="space-y-4 text-[15px] leading-[1.65] text-ink-secondary max-w-2xl">
                            ...
                            <p>
                                I've shipped products to the Play Store and App Store across eCommerce, e-learning, and AI-powered experiences using Google Cloud Vision and ML Kit. I care deeply about architecture — Clean Architecture, BLoC, Riverpod, MVVM — because clean code today saves you from chaos tomorrow.
                            </p>
                            <p>
                                I also build the backend that powers it all with Laravel and Firebase, so I can take a product from idea to a fully working system, front to back. Beyond the code, I lead reviews, mentor developers, and genuinely enjoy turning complicated problems into simple, clean solutions.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-8 flex flex-wrap items-center gap-3">
                <a href="#skills" data-track="view_skills" class="inline-flex items-center gap-2 text-[13.5px] font-medium hover:opacity-90 transition-opacity rounded-md px-4 py-2.5" style="background: var(--ink-primary); color: var(--bg-base);">
                    View skills
                ...
                <a href="/Shipon_Sarder_Resume.pdf" download data-track="cv_download" class="inline-flex items-center gap-2 text-[13.5px] font-medium text-ink-primary border border-border hover:border-border-strong transition-colors rounded-md px-4 py-2.5">
                ...
                <span class="h-4 w-px bg-border mx-1" aria-hidden="true"></span>
                <a href="https://linkedin.com/in/shipon-sarder-900727102" target="_blank" rel="noopener noreferrer" data-track="social_linkedin" class="p-1.5 text-ink-secondary hover:text-accent transition-colors" aria-label="LinkedIn">
                ...
                <a href="https://wa.me/8801925727000" data-track="social_whatsapp" class="p-1.5 text-ink-secondary hover:text-accent transition-colors" aria-label="WhatsApp">
                ...
                <a href="https://github.com/shipon0142" target="_blank" rel="noopener noreferrer" data-track="social_github" class="p-1.5 text-ink-secondary hover:text-accent transition-colors" aria-label="GitHub">
                ...
                <a href="mailto:shipon0142@gmail.com" data-track="social_email" class="p-1.5 text-ink-secondary hover:text-accent transition-colors" aria-label="Email">
            ...
            <div class="mt-14 pt-6 border-t border-border grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-8 max-w-3xl">
                ...
                <div>
                    ...
                    <p class="text-[13px] text-ink-secondary">Mobile Developer · Flutter &amp; Native Android · Dart · Kotlin · Java · KMP · AI-Powered Apps</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-content mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
                ...
                <div>
                    ...
                    <a href="mailto:shipon0142@gmail.com" data-track="contact_email" class="link-underline mt-8 inline-flex display-sans-light text-xl md:text-3xl text-accent">
                    ...
                    <div class="mt-10 pt-6 border-t border-border flex flex-wrap items-center gap-5 md:gap-7 text-ink-secondary">
                        <a href="https://linkedin.com/in/shipon-sarder-900727102" target="_blank" rel="noopener noreferrer" data-track="contact_linkedin" class="link-underline inline-flex items-center gap-2 text-[13.5px] hover:text-ink-primary transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4" aria-hidden="true"><path d="M20.5 2h-17A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h17a1.5 1.5 0 001.5-1.5v-17A1.5 1.5 0 0020.5 2zM8 19H5v-9h3zM6.5 8.25a1.75 1.75 0 110-3.5 1.75 1.75 0 010 3.5zM19 19h-3v-4.74c0-1.13-.02-2.58-1.57-2.58-1.57 0-1.81 1.23-1.81 2.5V19h-3v-9h2.88v1.23h.04a3.16 3.16 0 012.85-1.56c3.05 0 3.61 2 3.61 4.61z"/></svg>
                            LinkedIn
                        </a>
                        <a href="https://wa.me/8801925727000" data-track="contact_whatsapp" class="link-underline inline-flex items-center gap-2 text-[13.5px] hover:text-ink-primary transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4" aria-hidden="true"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.13.96.37 1.9.72 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.35 1.85.59 2.81.72A2 2 0 0122 16.92z"/></svg>
                            WhatsApp
                        </a>
                        <a href="tel:+8801925727000" data-track="contact_phone" class="link-underline inline-flex items-center gap-2 text-[13.5px] hover:text-ink-primary transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4" aria-hidden="true"><path d="M15.05 5A5 5 0 0 1 19 8.95M15.05 1A9 9 0 0 1 23 8.94M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                            +880 1925 727 000
                        </a>
                        <a href="https://github.com/shipon0142" target="_blank" rel="noopener noreferrer" data-track="contact_github" class="link-underline inline-flex items-center gap-2 text-[13.5px] hover:text-ink-primary transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4" aria-hidden="true"><path d="M12 .5C5.65.5.5 5.65.5 12c0 5.09 3.29 9.4 7.86 10.93.58.11.79-.25.79-.55 0-.27-.01-1.16-.02-2.11-3.19.69-3.87-1.36-3.87-1.36-.52-1.33-1.28-1.69-1.28-1.69-1.05-.71.08-.7.08-.7 1.16.08 1.77 1.19 1.77 1.19 1.03 1.77 2.7 1.26 3.36.96.1-.74.4-1.26.72-1.55-2.55-.29-5.23-1.28-5.23-5.68 0-1.25.45-2.28 1.19-3.09-.12-.29-.52-1.46.11-3.05 0 0 .97-.31 3.18 1.18a11.1 11.1 0 0 1 2.9-.39c.98 0 1.97.13 2.9.39 2.21-1.49 3.18-1.18 3.18-1.18.63 1.59.23 2.76.11 3.05.74.81 1.19 1.84 1.19 3.09 0 4.41-2.69 5.38-5.25 5.66.41.36.78 1.06.78 2.14 0 1.54-.01 2.79-.01 3.16 0 .3.21.67.8.55C20.21 21.4 23.5 17.09 23.5 12 23.5 5.65 18.35.5 12 .5z"/></svg>
                            GitHub
                        </a>
                        <a href="mailto:shipon0142@gmail.com" data-track="contact_email_icon" class="link-underline inline-flex items-center gap-2 text-[13.5px] hover:text-ink-primary transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 6l-10 7L2 6"/></svg>
                            Email
                        </a>
                    </div>
...
<footer class="border-t border-border py-8">
    <div class="max-w-content mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-3">
        <p class="font-mono text-[11px] text-ink-muted">© {{ date('Y') }} Shipon Sarder.</p>
...
<script>
    ...
    (function () {
        ...
        // Page visit — once per browser session
        if (!sessionStorage.getItem('_portfolio_visited')) {
            sessionStorage.setItem('_portfolio_visited', '1');
            track('page_visit');
        }
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', attachTrackers);
        } else {
            attachTrackers();
        }
    })();
